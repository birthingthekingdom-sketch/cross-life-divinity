  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <Badge className="mb-4">Professional Certificates</Badge>
            <h2 className="text-4xl font-bold mb-4">Your Certificate Preview</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See what your professional CLAC-accredited certificate will look like upon course completion.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border-2 border-primary">
              <CardHeader className="bg-primary/5">
                <CardTitle className="text-2xl text-center">Sample Certificate</CardTitle>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="bg-white rounded-lg shadow-lg p-4 mb-6">
                  <iframe 
                    src="/sample-certificate.pdf" 
                    className="w-full h-[500px] border-0 rounded"
                    title="Sample Certificate Preview"
                  />
                </div>
                
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-3">
                    <h3 className="font-semibold text-lg mb-3">Certificate Features:</h3>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Traditional academic design matching Liberty & GCU</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Professional gold border and navy blue accents</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">CLSD seal and CLAC accreditation statement</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Formal certificate language with signature lines</span>
                    </div>
                  </div>

                  <div className="space-y-3">
                    <h3 className="font-semibold text-lg mb-3">Verification & Security:</h3>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Unique certificate number for tracking</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">QR code for instant online verification</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Secure blockchain-backed verification system</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Printable on archival-quality certificate paper</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg mb-2">Certificate Upgrade Promise</h4>
                      <p className="text-muted-foreground mb-3">
                        When Cross Life School of Divinity achieves full accreditation, all certificates will be 
                        automatically upgraded to reflect the new accreditation status at no additional cost to you.
                      </p>
                      <p className="text-sm text-muted-foreground">
                        Your investment is protected. Your certificates are stored permanently in our system and will 
                        be upgraded automatically when we achieve ATS or ABHE accreditation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 text-center">
                  <a href="/sample-certificate.pdf" download className="inline-block">
