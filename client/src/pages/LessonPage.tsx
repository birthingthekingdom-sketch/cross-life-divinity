      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
        ...
        >
          <div className="container py-6">
            ...
            <h1 className="text-3xl font-bold" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.3)' }}>{lesson.title}</h1>
            {course && (
              <p className="text-white/80 mt-2" style={{ textShadow: '0 1px 2px rgba(0, 0, 0, 0.2)' }}>{course.title} - {course.code}</p>
            )}
          </div>
        </div>
