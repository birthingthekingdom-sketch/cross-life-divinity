...
async function seedLessons() {
  ...
  // Parse URL: mysql://user:pass@host:port/database?ssl=...
  ...
  try {
    ...
    for (const [courseCode, lessonsList] of Object.entries(GED_LESSONS)) {
      ...
      console.log(`Processing ${courseCode} (ID: ${courseId}) with ${lessonsList.length} lessons...`);
