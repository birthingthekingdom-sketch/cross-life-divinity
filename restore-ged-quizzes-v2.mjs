...
console.log('Starting GED Quiz Restoration (Version 2)...\n');

// GED MATH Quiz Data - mapped to actual lesson IDs
...
for (const [lessonId, questions] of Object.entries(gedMathQuizzes)) {
  ...
  console.log(`✅ Added ${questions.length} quizzes for lesson ID: ${lessonId}`);
}

console.log(`\n✅ Total GED Math quiz questions inserted: ${totalInserted}`);
console.log('\nNote: Quiz questions for Language Arts, Science, and Social Studies can be added similarly.');
